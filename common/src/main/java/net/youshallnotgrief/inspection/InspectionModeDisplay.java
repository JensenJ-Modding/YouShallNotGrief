...
public abstract class InspectionModeDisplay {
    ...
    private static Component getHeaderForEntity(Entity entity, BlockPos pos, String dimensionID){
        MutableComponent entityComp = Component.literal(EntityUtils.getEntityName(entity))
                .withStyle(style -> style
                        ...
                        .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal(EntityUtils.getEntityIDFromEntity(entity.getType()))))
                );
        ...
        return Component.translatable("msg.youshallnotgrief.inspection.header", entityComp, position, dimension).withStyle(style -> style
    ...
    private static Component getHeaderForBlock(Level level, BlockPos pos, String dimensionID){
        MutableComponent blockComp = Component.literal(BlockUtils.getBlockName(level.getBlockState(pos)))
                .withStyle(style -> style
                        .withColor(MiscUtils.getTextColourFromConfig(ServerConfig.inspectionPrimaryColour.get()))
                        .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal(BlockUtils.getBlockID(level.getBlockState(pos)))))
                );
