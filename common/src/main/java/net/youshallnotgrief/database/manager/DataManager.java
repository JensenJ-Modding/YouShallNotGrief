...
public abstract class DataManager<InsertData> extends TableManager<InsertData> {
    ...
    protected abstract int setRetrievePreparedStatementValues(PreparedStatement preparedStatement, InsertData data)
            throws SQLException;
    ...
    protected abstract void setUpdatePreparedStatementValues(PreparedStatement preparedStatement, InsertData data)
            throws SQLException;
    ...
    protected void setRetrievePreparedStatementValuesWithLimits(
            PreparedStatement preparedStatement, InsertData data, int limit, int offset) throws SQLException {
