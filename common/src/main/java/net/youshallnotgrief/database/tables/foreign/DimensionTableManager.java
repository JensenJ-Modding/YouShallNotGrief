...
public class DimensionTableManager extends ForeignTableManager<String> {
    ...
    public String getInsertSQL() {
        return "INSERT INTO dimensions (dimension) " +
    ...
    @Override
    public void setInsertPreparedStatementValues(PreparedStatement preparedStatement, String dimension) throws SQLException {
