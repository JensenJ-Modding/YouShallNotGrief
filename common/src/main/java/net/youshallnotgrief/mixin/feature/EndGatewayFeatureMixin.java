...
public class EndGatewayFeatureMixin {
    @WrapOperation(method="place", at = @At(value="INVOKE", target="Lnet/minecraft/world/level/levelgen/feature/EndGatewayFeature;setBlock(Lnet/minecraft/world/level/LevelWriter;Lnet/minecraft/core/BlockPos;Lnet/minecraft/world/level/block/state/BlockState;)V"))
    public void youshallnotgrief$logGatewayCreation(EndGatewayFeature instance, LevelWriter levelWriter, BlockPos pos, BlockState state, Operation<Void> original) {
