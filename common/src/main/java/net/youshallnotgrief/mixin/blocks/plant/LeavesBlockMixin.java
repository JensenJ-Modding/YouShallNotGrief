...
@Mixin(value = LeavesBlock.class, priority = 10100)
public abstract class LeavesBlockMixin {
    ...
    public boolean youshallnotgrief$logLeafDecay(
        ...
        return BlockUtils.wrapLevelRemoveBlock(level, pos, b, original, oldState -> {
            if (ServerConfig.logDecay.get()) {
                BlockUtils.addToDatabase(
                        pos, level, oldState, Blocks.AIR.defaultBlockState(), BlockSetCauses.DECAY, null, "");
            }
        });
    }
}
