...
public class BedItemMixin {
    ...
    private boolean youshallnotgrief$logBedPlace(Level level, BlockPos pos, BlockState state, int i, Operation<Boolean> original, @Local(argsOnly = true) BlockPlaceContext context){
